                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">вввв</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-lg-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Добавление в базу данных моих мест работы</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="" method="post" name="form">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="url" type="text" class="form-control" id="exampleInputPassword1"
                                               placeholder="url">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input name="code" type="text" class="form-control" id="exampleInputPassword1"
                                               placeholder="Только на анг">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Картинка компании</label>
                                        <input name="img" type="text" class="form-control" id="exampleInputPassword1"
                                               placeholder="Картинка компании">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Дата публикации</label>
                                        <input name="date" type="text" class="form-control" id="exampleInputPassword1"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="experience" type="text" class="form-control"
                                               id="exampleInputPassword1" placeholder="Продолжительность работы">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Описание</label>
                                        <input name="discription" type="text" class="form-control"
                                               id="exampleInputPassword1" placeholder="Описание">
                                    </div>
                                </div>
